      ...
      body: Center(
        child: ListView(
          padding: const EdgeInsets.all(8), children: <Widget>[
            ...
            Text("Click en elige una Imagen para seleccionar una Imagen"),
            Padding(
            ...
            Text("Click en toma una foto para abrir la Camara", style: TextStyle(fontSize: 16),),
            ...
            Padding(
              ...
              child: RaisedButton(
                  ...
                  color: Colors.black,
                  child: Text("Elige un video de galeria")),
            ),

          Text("Click en grabar video para abrir la Camara", style: TextStyle(fontSize: 16),),
            Padding(
              padding: const EdgeInsets.fromLTRB(60,  8, 60, 8),
              child: RaisedButton(
                  onPressed: (){
